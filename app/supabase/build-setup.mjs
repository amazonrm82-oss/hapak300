...
const TITLES = {
  ...
  audit: 'ניתוק מכשירים ויומן פעולות',
  period: 'תקופות, פרטי לוחם וגיבוי',
  drills: 'מקצים וציונים',
  roles: 'רס״פ וסמל צוות — תפקידים שנושאים הרשאה',
  absence: 'היעדרות עם תאריכים',
  sight: 'כוונת אישית',
  npak: 'נפ״ק — מי נוסע באיזה רכב',
  staff: 'המפקדה — תקן, לא מקום לחנות בו אנשים',
  one_mahat: 'מח״ט אחד, סמח״ט אחד',
  own_kit: 'כל אחד מעדכן את הציוד של עצמו',
  staff_joins: 'המפקדה מצטרפת לאימון בעצמה',
  agam: 'קצין אג״ם במפקדה, תקן אחד',
  seed: 'נתוני פתיחה',
};
